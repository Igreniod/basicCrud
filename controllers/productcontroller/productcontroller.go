...
import (
	...
	"github.com/Igreniod/basicCrud/utils"
	"github.com/gin-gonic/gin"
	"gorm.io/gorm"
)

func Index(c *gin.Context) {
	var products []models.Product // pengunaan [] untuk mengambil banyak data
...
func Create(c *gin.Context) {
	...
	product.HargaDiskon = utils.CalculateDiscountedPrice(product.Harga, product.Diskon)

	datadua, err := json.MarshalIndent(product, "", "    ")
	if err != nil {
		fmt.Println("Error:", err)
		return
	}

	fmt.Println(string(datadua))
